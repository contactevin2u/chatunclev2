...
export const metadata: Metadata = {
  ...
  description: 'MMDR registered medical device supplier in Malaysia. Hospital beds, oxygen concentrators, wheelchairs, compression stockings. Superbrands 2025. Free delivery KL & Selangor. Official MDA Malaysia registered.',
  keywords: [
    'medical devices malaysia',
    'MMDR registered supplier',
    'MDA Malaysia medical device',
    ...
    'AA Alive Sdn Bhd',
    'registered medical device distributor',
    'katil hospital malaysia',
    'beli sewa katil hospital',
    'Evin medical products',
    'Evin Malaysia',
    'medical equipment Shopee',
    'medical equipment Lazada',
...
const productCategories = [
  ...
  },
  {
    ...
    price: 'From RM 2,800',
    link: '/medical-devices/oxygen-concentrators',
  },
  {
    ...
    price: 'From RM 3,500',
    link: '/medical-devices/electric-wheelchairs',
  },
  {
    name: 'CPAP Machines',
    slug: 'cpap-machines',
    description: 'CPAP and BiPAP machines for sleep apnea treatment. Auto CPAP, travel CPAP, and full accessories.',
    icon: Moon,
    color: 'bg-indigo-500',
    keywords: ['CPAP machine malaysia', 'sleep apnea treatment', 'BiPAP machine'],
    features: ['Auto CPAP', 'BiPAP available', 'Travel units', 'Mask fitting'],
    price: 'From RM 1,800',
    link: '/medical-devices/cpap-machines',
  },
  {
...
const organizationSchema = {
  ...
  sameAs: [
    ...
    'https://evin.my',
    'https://evin2u.com',
    'https://shopee.com.my/evinmedical',
    'https://lazada.com.my/shop/evin-medical',
  ],
  hasOfferCatalog: {
    '@type': 'OfferCatalog',
